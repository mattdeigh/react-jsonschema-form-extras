...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleBlur = function () {
    var _props2 = _this3.props,
        _props2$uiSchema$upda = _props2.uiSchema.updateOnBlur,
        updateOnBlur = _props2$uiSchema$upda === undefined ? false : _props2$uiSchema$upda,
  ...
  this.handleOnFocus = function () {
    ...
    var _props3 = _this3.props,
        _props3$uiSchema$draf = _props3.uiSchema.draftRte,
        _props3$uiSchema$draf2 = _props3$uiSchema$draf.enableAutocomplete,
        enableAutocomplete = _props3$uiSchema$draf2 === undefined ? false : _props3$uiSchema$draf2,
        _props3$uiSchema$draf3 = _props3$uiSchema$draf.autocomplete,
        autocomplete = _props3$uiSchema$draf3 === undefined ? {} : _props3$uiSchema$draf3,
